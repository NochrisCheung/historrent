...
**status:** Phase 8.5 complete (2026-05-05) — pan/zoom polish + seven user revisions. Final state: straight horizontal string with viewport-relative edge blur (8.5.11); cluster-based label lane placement that produces an arch with both ends on the line and the peak inside dense clusters (8.5.13, replaces 8.5.12's right-to-left walk). 91 unit + 21 E2E green. Phase 9 (AI synthesis) unblocked.
