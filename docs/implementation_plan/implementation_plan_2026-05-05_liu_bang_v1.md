...
**status:** Phase 8.5 complete (2026-05-05) — pan/zoom polish: pixel-stable line + dot thickness across zooms, world-anchored wave phase (curl tails scroll during drag for visible motion cue), bottom-left interval legend (10 年 / 1 年 / 1 月). 102 unit + 20 E2E green. Phase 9 (AI synthesis) unblocked.
